...
class PauseMenu(object):
	...
	def __init__(self):
		...
		# 一层菜单
		self.button_rect.append([35, 320])			# 定位 'To_Title_Start' 按键位置
		self.button_rect.append([40, 352])			# 定位 'Retry_Start' 按键位置
