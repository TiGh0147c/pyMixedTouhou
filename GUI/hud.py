...
class Hud(object):
	def __init__(self, blood=None):
		...
		self.posi.append((418, 50, 64, 40))
		self.posi.append((418, 110, 64, 40))
		self.im = []
		...
		self.im.append(self.picture.subsurface(256, 0, 80, 40))
		self.im.append(self.picture.subsurface(256, 40, 80, 40))
		self.num = []
		for i in range(0, 10):
	...
	def draw(self, screen):
		...
		for i in range(0, 9):
			screen.blit(self.num[int(high_score/(10**(8-i))) % 10], (490+15*i, 50))
		for i in range(0, 9):
			screen.blit(self.num[int(score/(10**(8-i))) % 10], (490+15*i, 70))
		for i in range(0, life):
			screen.blit(self.star, (490+i*16, 112))

		screen.blit(self.dot, (490+15, 141))

		screen.blit(self.num[int(power/100)], (490, 128))
		screen.blit(self.num[int(power%100/10)], (508, 128))
		screen.blit(self.num[int(power%10)], (522, 128))
